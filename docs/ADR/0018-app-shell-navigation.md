...
> **关联文档**：
> - [UI_SPEC.md](../UI_SPEC.md)（Screen 10 Home v3 / Screen 7 Files / Screen 8 Me / Bottom Tab Bar 视觉规范——本 ADR 不重复视觉细节，只冻结架构）
...
- [UI_SPEC.md](../UI_SPEC.md) Screen 10/7/8：Bottom Tab Bar 为 4 等分 Tab（首页/文件/阅读/我的），Editor 与 Reader 阅读态为 Immersive（无 Tab Bar）。
