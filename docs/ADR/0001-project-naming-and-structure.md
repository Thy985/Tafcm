...
3. **现有问题**：
   - `lib/providers/` 与 `lib/domain/providers/` 职责重叠，是 P0 阻塞问题（见 [CRITICAL_REVIEW.md §2.4](file:///d:/Projects/Active/math2/docs/CRITICAL_REVIEW.md)）
...
- [CRITICAL_REVIEW.md](file:///d:/Projects/Active/math2/docs/CRITICAL_REVIEW.md) §2.4
