...
- **关联**：[ADR-0024 Agent Diagnostic Interface](./0024-agent-diagnostic-interface.md)（§2.4 Validation Adapter 定义 Dart 侧 `before` 枚举）/ [ADI Design Document v1.0](../../design/adi-design-v1.md) / [ADL-LOOP-RUN-007.md](../../archive/runs/adl/ADL-LOOP-RUN-007.md)（F2 验收）
