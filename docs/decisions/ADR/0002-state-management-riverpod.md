...
3. **Provider 类型选择** 严格按 [CODING_RULES.md §5.1](../../engineering/DEVELOPMENT-RULES.md#51-provider-选择决策树) 决策树
4. **状态不可变**：所有 `StateNotifier<S>` 的 `S` 必须不可变
5. **Provider 归属** 严格按 [CODING_RULES.md §5.3](../../engineering/DEVELOPMENT-RULES.md#53-归属)
...
- [CODING_RULES.md §5](../../engineering/DEVELOPMENT-RULES.md) Riverpod 详细规则
- [CRITICAL_REVIEW.md §2.4](../../archive/audits/CRITICAL-REVIEW.md) Provider 重复定义问题
