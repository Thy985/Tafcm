...
但当前编辑范式仍是 **编辑/预览分离**（[editor_screen.dart:300-321](file:///d:/Projects/Active/math2/flutter_app/lib/presentation/screens/editor_screen.dart#L300-321)），与 Typora 的 **WYSIWYG** 哲学对立（详见 [CRITICAL_REVIEW §1.1](../../archive/audits/CRITICAL-REVIEW.md)）。
