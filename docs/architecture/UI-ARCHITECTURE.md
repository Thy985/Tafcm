...
**核心原则**：UI 状态单独建模，不污染 AST（[ADR-0009 §2](../decisions/ADR/0009-ui-architecture-design.md)）
...
class BlockViewState {
  ...
  ///   （[ADR-0007 §5](../decisions/ADR/0007-blockeditor-abstraction-design.md)）
...
详见 [Component-Tree.md §1.2](UI-COMPONENT-MODEL.md)。
...
- 详见 [Interaction-Model.md §2](UI-INTERACTION-MODEL.md)（v1.1 流：EditorCommand → CommandHandler → TransactionBuilder → BlockOperation）
...
**详见 [ADR-0007 §5](../decisions/ADR/0007-blockeditor-abstraction-design.md) IME 三铁律**
