  ...
  group('TC-ARCH-MODEL-4 presentation 禁 Colors.* 直写', () {
    test('lib/presentation/{screens,widgets,blocks,panels,components} 无新增 Colors.* 直写', () {
      ...
      const knownOffenders = <String>[
        ...
        'lib/presentation/widgets/preview_content.dart:119',
        'lib/presentation/widgets/preview_content.dart:120',
        'lib/presentation/widgets/preview_content.dart:130',
        'lib/presentation/widgets/preview_content.dart:36',
